...
_SELF = TargetRule(scope=TargetScope.SELF_ARMY)
...
AMANE_TRI_PHALANX_BUFF = register_status(StatusDefinition(
    ...
    name="Tri-Phalanx",
    default_duration=-1,
    effects=[SkillEffect(effect_type=EffectType.DAMAGE_UP, effect_op=102, target_rule=_SELF, duration=_PERMANENT)],
...
CHENKO_STAND_OF_ARMS_BUFF = register_status(StatusDefinition(
    ...
    name="Stand of Arms",
    default_duration=-1,
    effects=[SkillEffect(effect_type=EffectType.DAMAGE_UP, effect_op=101, target_rule=_SELF, duration=_PERMANENT)],
    stack_rule=StackRule.STACK,
))
...
SAUL_TASKFORCE_BUFF = register_status(StatusDefinition(
    ...
    default_duration=-1,
    effects=[
        SkillEffect(effect_type=EffectType.DEFENSE_UP, effect_op=112, target_rule=_SELF, duration=_PERMANENT),
        SkillEffect(effect_type=EffectType.DEFENSE_UP, effect_op=113, target_rule=_SELF, duration=_PERMANENT),
    ],
    stack_rule=StackRule.STACK,
))
...
HILDE_NOBLE_PATH_BUFF = register_status(StatusDefinition(
    ...
    default_duration=-1,
    effects=[
        SkillEffect(effect_type=EffectType.DAMAGE_UP, effect_op=102, target_rule=_SELF, duration=_PERMANENT),
        SkillEffect(effect_type=EffectType.DEFENSE_UP, effect_op=112, target_rule=_SELF, duration=_PERMANENT),
    ],
    stack_rule=StackRule.STACK,
))
...
CURSED = register_status(StatusDefinition(
    ...
    effects=[
        SkillEffect(effect_type=EffectType.DAMAGE_UP, effect_op=103, target_rule=TargetRule(scope=TargetScope.CURRENT_TARGET), duration=_PERMANENT),
    ],
...
_amane_tri_phalanx = HeroSkillDefinition(
    ...
    effects=[SkillEffect(effect_type=EffectType.APPLY_STATUS, effect_op=AMANE_TRI_PHALANX_BUFF.id, target_rule=_SELF, duration=_PERMANENT)],
    conditions=[],
    level_data={
...
_chenko_stand_of_arms = HeroSkillDefinition(
    ...
    name="Stand of Arms",
    trigger=TriggerType.ALWAYS,
    effects=[SkillEffect(effect_type=EffectType.APPLY_STATUS, effect_op=CHENKO_STAND_OF_ARMS_BUFF.id, target_rule=_SELF, duration=_PERMANENT)],
    conditions=[],
    level_data={
...
_saul_taskforce_training = HeroSkillDefinition(
    ...
    name="Taskforce Training",
    trigger=TriggerType.ALWAYS,
    effects=[SkillEffect(effect_type=EffectType.APPLY_STATUS, effect_op=SAUL_TASKFORCE_BUFF.id, target_rule=_SELF, duration=_PERMANENT)],
    conditions=[],
    level_data={
...
_hilde_noble_path = HeroSkillDefinition(
    ...
    name="Noble Path",
    trigger=TriggerType.ALWAYS,
    effects=[SkillEffect(effect_type=EffectType.APPLY_STATUS, effect_op=HILDE_NOBLE_PATH_BUFF.id, target_rule=_SELF, duration=_PERMANENT)],
    conditions=[],
    level_data={
...
_petra_evil_eye = HeroSkillDefinition(
    ...
    effects=[
        SkillEffect(
            ...
            effect_op=CURSED.id,
            target_rule=TargetRule(scope=TargetScope.CURRENT_TARGET),
            duration=_PERMANENT,
        ),
    ],
